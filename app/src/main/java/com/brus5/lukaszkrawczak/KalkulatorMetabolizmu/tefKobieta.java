...
public class tefKobieta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tef_kobieta);
    ...
    public void showResult() {
        new Handler().postDelayed(new Runnable() {
            ...
            tefInfoTextView.setVisibility(View.VISIBLE);
                tefInfoTextView.startAnimation(AnimationUtils.loadAnimation(tefKobieta.this, android.R.anim.fade_in));
            }
        }, 1000);
        new Handler().postDelayed(new Runnable() {
            @Override
            ...
            tefTextView.startAnimation(AnimationUtils.loadAnimation(tefKobieta.this, android.R.anim.fade_in));
            }
        }, 1500);
    ...
    public void next() {
        ...
        Intent intent = new Intent(tefKobieta.this, neatKobieta.class);
    ...
    public void onViewClicked(){
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                TextView10.startAnimation(AnimationUtils.loadAnimation(tefKobieta.this, android.R.anim.fade_in));
            }
        },1000);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                TextView8.startAnimation(AnimationUtils.loadAnimation(tefKobieta.this, android.R.anim.fade_in));
            }
        },1500);
    }
