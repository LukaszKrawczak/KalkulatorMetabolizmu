...
public class neatMezczyzna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neat_mezczyzna);
    ...
    public void showResult() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                infoTextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 1000);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                cpmFinalTextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 2000);
    }
    ...
    public void onViewClicked() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                neatinfoTextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 500);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                neatinfo1TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 1500);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                neatinfo2TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 2000);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                neatinfo3TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 2500);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                neatinfo4TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 3000);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                neatinfo5TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 3500);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                neatinfo6TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 4000);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                neatinfo7TextView.startAnimation(AnimationUtils.loadAnimation(neatMezczyzna.this, android.R.anim.fade_in));
            }
        }, 4500);
